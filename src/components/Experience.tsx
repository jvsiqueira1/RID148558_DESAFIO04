  ...
  const experiences = [
    {
      ...
      technologies: ['Java', 'Spring Boot', 'React.js', 'Python', 'Web Scraping'],
    },
    {
      id: 2,
      title: 'Desenvolvedor Full Stack',
      company: 'Agilizei',
      locationKey: 'experience.location.brazil',
      period: { pt: 'Mar. de 2025 - Jun. de 2025', en: 'Mar. 2025 - Jun. 2025' },
      descriptionKey: 'experience.agilizei.description',
      technologies: ['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'Prisma ORM', 'Git', 'APIs RESTful'],
    },
    {
      id: 3,
      ...
      company: 'Central IT',
      locationKey: 'experience.location.brazil',
      period: { pt: 'Out. de 2023 - Dez. de 2024', en: 'Oct. 2023 - Dec. 2024' },
      descriptionKey: 'experience.centralit.description',
      technologies: ['React.js', 'Tailwind CSS', 'APIs RESTful', 'Git', 'GitLab', 'Scrum'],
    },
    {
      id: 4,
      ...
      period: { pt: 'Set. de 2021 - Set. de 2023', en: 'Sep. 2021 - Sep. 2023' },
      descriptionKey: 'experience.detran.description',
      technologies: ['Suporte Técnico', 'Redes', 'Manutenção de Hardware', 'Sistemas Internos'],
    },
  ];
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4 gap-4">
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-foreground mb-2">{experience.title}</h3>
                  <div className="flex flex-wrap items-center gap-4 text-sm md:text-base">
                    ...
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      {experience.locationKey ? t(experience.locationKey) : (typeof experience.location === 'object' ? experience.location[language] : experience.location)}
                    </div>
                    <div className="flex items-center gap-2 text-muted-foreground">
                      <Calendar className="w-4 h-4" />
                      {typeof experience.period === 'object' ? experience.period[language] : experience.period}
                    </div>
                  </div>
                </div>
              </div>
