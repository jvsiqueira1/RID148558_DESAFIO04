...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const t = (key: string): string => {
    const translations: Record<string, Record<Language, string>> = {
      ...
      'hero.description': {
        pt: 'Desenvolvedor Full Stack com experiência prática em projetos reais, atuando em equipes que seguem metodologias ágeis. Especializado em desenvolvimento de sistemas web com Java, Spring Boot, React.js e Python. Tenho compromisso com a criação de soluções acessíveis e de qualidade, sempre buscando aprimorar meus conhecimentos e habilidades técnicas.',
        en: 'Full Stack Developer with practical experience in real projects, working in teams that follow agile methodologies. Specialized in web systems development with Java, Spring Boot, React.js and Python. I am committed to creating accessible and quality solutions, always seeking to improve my knowledge and technical skills.'
      },
      'hero.cta': { pt: 'Saiba mais', en: 'Learn more' },
      
      // Projects
      'projects.title': { pt: 'Projetos', en: 'Projects' },
      'projects.subtitle': { pt: 'Alguns dos projetos que desenvolvi e participei', en: 'Some of the projects I developed and participated in' },
      ...
      'technologies.subtitle': { pt: 'Ferramentas e linguagens com as quais tenho experiência', en: 'Tools and languages I have experience with' },
      'technologies.categories.languages': { pt: 'Linguagens', en: 'Languages' },
      ...
      'technologies.categories.devops': { pt: 'DevOps & Cloud', en: 'DevOps & Cloud' },
      'technologies.categories.tools': { pt: 'Ferramentas & Metodologias', en: 'Tools & Methodologies' },
      
      // Experience
      'experience.title': { pt: 'Experiências Profissionais', en: 'Professional Experience' },
      'experience.subtitle': { pt: 'Minha trajetória profissional e contribuições em projetos reais', en: 'My professional journey and contributions to real projects' },
      ...
      'about.subtitle': { pt: 'Minha jornada profissional e acadêmica, desde os primeiros passos até os desafios atuais', en: 'My professional and academic journey, from the first steps to current challenges' },
      'about.contact.title': { pt: 'Entre em Contato', en: 'Get in Touch' },
      'about.contact.subtitle': { pt: 'Estou sempre aberto a novas oportunidades e conversas sobre tecnologia', en: 'I am always open to new opportunities and conversations about technology' },
      ...
      'about.roadmap.education.title': { pt: 'Início da Graduação', en: 'Start of Graduation' },
      'about.roadmap.education.subtitle': { pt: 'Engenharia da Computação - UFMT', en: 'Computer Engineering - UFMT' },
      ...
      'about.roadmap.internship.title': { pt: 'Primeiro Estágio', en: 'First Internship' },
      'about.roadmap.internship.subtitle': { pt: 'Estagiário de Suporte - Detran MT', en: 'Support Intern - Detran MT' },
      ...
      'about.roadmap.frontend.title': { pt: 'Desenvolvedor Front End', en: 'Front End Developer' },
      'about.roadmap.frontend.subtitle': { pt: 'Central IT - Out. 2023 a Dez. 2024', en: 'Central IT - Oct. 2023 to Dec. 2024' },
      ...
      'about.roadmap.growth.title': { pt: 'Aprofundamento Técnico', en: 'Technical Deepening' },
      'about.roadmap.growth.subtitle': { pt: 'Expansão de Conhecimentos', en: 'Knowledge Expansion' },
      ...
      'about.roadmap.fullstack1.title': { pt: 'Desenvolvedor Full Stack', en: 'Full Stack Developer' },
      'about.roadmap.fullstack1.subtitle': { pt: 'Agilizei - Mar. a Jun. 2025', en: 'Agilizei - Mar. to Jun. 2025' },
      ...
      'about.roadmap.fullstack2.title': { pt: 'Desenvolvedor Full Stack', en: 'Full Stack Developer' },
      'about.roadmap.fullstack2.subtitle': { pt: 'Grupo Optimus - Set. 2025 (Atual)', en: 'Grupo Optimus - Sep. 2025 (Current)' },
      ...
      'projects.agilizei': {
        pt: 'Plataforma web que conecta clientes a profissionais de serviços gerais de forma prática e segura. O sistema permite que usuários encontrem, avaliem e contratem profissionais qualificados para diversas demandas residenciais e comerciais, facilitando o processo de orçamento, negociação e agendamento. Inspirado em modelos como o GetNinjas, o projeto prioriza usabilidade, transparência e eficiência na comunicação entre as partes, oferecendo uma solução completa para simplificar a contratação de serviços.',
        en: 'Web platform that connects clients to general service professionals in a practical and secure way. The system allows users to find, evaluate and hire qualified professionals for various residential and commercial demands, facilitating the process of budgeting, negotiation and scheduling. Inspired by models like GetNinjas, the project prioritizes usability, transparency and efficiency in communication between parties, offering a complete solution to simplify service contracting.'
      },
      'projects.gestao': {
